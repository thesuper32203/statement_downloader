...
cash_flow_report_instance = CashFlowReport.from_json(json)
# print the JSON string representation of the object
print(CashFlowReport.to_json())

# convert the object into a dict
cash_flow_report_dict = cash_flow_report_instance.to_dict()
# create an instance of CashFlowReport from a dict
cash_flow_report_from_dict = CashFlowReport.from_dict(cash_flow_report_dict)
```
