...
json = "{}"
# create an instance of VOIReport from a JSON string
voi_report_instance = VOIReport.from_json(json)
# print the JSON string representation of the object
print(VOIReport.to_json())

# convert the object into a dict
voi_report_dict = voi_report_instance.to_dict()
# create an instance of VOIReport from a dict
voi_report_from_dict = VOIReport.from_dict(voi_report_dict)
```
