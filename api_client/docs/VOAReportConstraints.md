...
voa_report_constraints_instance = VOAReportConstraints.from_json(json)
# print the JSON string representation of the object
print(VOAReportConstraints.to_json())

# convert the object into a dict
voa_report_constraints_dict = voa_report_constraints_instance.to_dict()
# create an instance of VOAReportConstraints from a dict
voa_report_constraints_from_dict = VOAReportConstraints.from_dict(voa_report_constraints_dict)
```
