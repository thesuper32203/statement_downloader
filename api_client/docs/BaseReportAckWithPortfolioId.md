...
json = "{}"
# create an instance of BaseReportAckWithPortfolioId from a JSON string
base_report_ack_with_portfolio_id_instance = BaseReportAckWithPortfolioId.from_json(json)
# print the JSON string representation of the object
print(BaseReportAckWithPortfolioId.to_json())

# convert the object into a dict
base_report_ack_with_portfolio_id_dict = base_report_ack_with_portfolio_id_instance.to_dict()
# create an instance of BaseReportAckWithPortfolioId from a dict
base_report_ack_with_portfolio_id_from_dict = BaseReportAckWithPortfolioId.from_dict(base_report_ack_with_portfolio_id_dict)
```
