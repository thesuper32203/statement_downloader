...
json = "{}"
# create an instance of VOIReportConstraintsOut from a JSON string
voi_report_constraints_out_instance = VOIReportConstraintsOut.from_json(json)
# print the JSON string representation of the object
print(VOIReportConstraintsOut.to_json())

# convert the object into a dict
voi_report_constraints_out_dict = voi_report_constraints_out_instance.to_dict()
# create an instance of VOIReportConstraintsOut from a dict
voi_report_constraints_out_from_dict = VOIReportConstraintsOut.from_dict(voi_report_constraints_out_dict)
```
