...
**pay_statements** | [**List[VOIEPaystubPayStatement]**](VOIEPaystubPayStatement.md) | Extracted pay statement details, and the transaction matching summary | [optional] 
...
json = "{}"
# create an instance of VOIEPaystubReport from a JSON string
voie_paystub_report_instance = VOIEPaystubReport.from_json(json)
# print the JSON string representation of the object
print(VOIEPaystubReport.to_json())

# convert the object into a dict
voie_paystub_report_dict = voie_paystub_report_instance.to_dict()
# create an instance of VOIEPaystubReport from a dict
voie_paystub_report_from_dict = VOIEPaystubReport.from_dict(voie_paystub_report_dict)
```
