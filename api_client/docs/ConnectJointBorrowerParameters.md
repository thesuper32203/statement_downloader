...
connect_joint_borrower_parameters_instance = ConnectJointBorrowerParameters.from_json(json)
# print the JSON string representation of the object
print(ConnectJointBorrowerParameters.to_json())

# convert the object into a dict
connect_joint_borrower_parameters_dict = connect_joint_borrower_parameters_instance.to_dict()
# create an instance of ConnectJointBorrowerParameters from a dict
connect_joint_borrower_parameters_from_dict = ConnectJointBorrowerParameters.from_dict(connect_joint_borrower_parameters_dict)
```
