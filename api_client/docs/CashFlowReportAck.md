...
json = "{}"
# create an instance of CashFlowReportAck from a JSON string
cash_flow_report_ack_instance = CashFlowReportAck.from_json(json)
# print the JSON string representation of the object
print(CashFlowReportAck.to_json())

# convert the object into a dict
cash_flow_report_ack_dict = cash_flow_report_ack_instance.to_dict()
# create an instance of CashFlowReportAck from a dict
cash_flow_report_ack_from_dict = CashFlowReportAck.from_dict(cash_flow_report_ack_dict)
```
