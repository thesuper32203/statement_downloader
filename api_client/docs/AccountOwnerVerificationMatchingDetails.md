...
**name_scores** | [**NameScore**](NameScore.md) |  | 
...
account_owner_verification_matching_details_instance = AccountOwnerVerificationMatchingDetails.from_json(json)
# print the JSON string representation of the object
print(AccountOwnerVerificationMatchingDetails.to_json())

# convert the object into a dict
account_owner_verification_matching_details_dict = account_owner_verification_matching_details_instance.to_dict()
# create an instance of AccountOwnerVerificationMatchingDetails from a dict
account_owner_verification_matching_details_from_dict = AccountOwnerVerificationMatchingDetails.from_dict(account_owner_verification_matching_details_dict)
```
