...
json = "{}"
# create an instance of AFBalanceAnalyticsReport from a JSON string
af_balance_analytics_report_instance = AFBalanceAnalyticsReport.from_json(json)
# print the JSON string representation of the object
print(AFBalanceAnalyticsReport.to_json())

# convert the object into a dict
af_balance_analytics_report_dict = af_balance_analytics_report_instance.to_dict()
# create an instance of AFBalanceAnalyticsReport from a dict
af_balance_analytics_report_from_dict = AFBalanceAnalyticsReport.from_dict(af_balance_analytics_report_dict)
```
