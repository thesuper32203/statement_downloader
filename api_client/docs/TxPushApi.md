...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TxPushApi(api_client)
    customer_id = '1005061234' # str | A customer ID
    account_id = '5011648377' # str | The account ID
    test_tx_push_transaction = openapi_client.TestTxPushTransaction() # TestTxPushTransaction | 

    try:
        # Create TxPush Test Transaction
        api_response = api_instance.create_tx_push_test_transaction(customer_id, account_id, test_tx_push_transaction)
        print("The response of TxPushApi->create_tx_push_test_transaction:\n")
        pprint(api_response)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    customer_id = '1005061234' # str | A customer ID
    account_id = '5011648377' # str | The account ID
    tx_push_subscription_parameters = openapi_client.TxPushSubscriptionParameters() # TxPushSubscriptionParameters | 

    try:
        # Subscribe to TxPush Notifications
        api_response = api_instance.subscribe_to_tx_push_notifications(customer_id, account_id, tx_push_subscription_parameters)
        print("The response of TxPushApi->subscribe_to_tx_push_notifications:\n")
        pprint(api_response)
    except Exception as e:
