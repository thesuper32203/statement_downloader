...
json = "{}"
# create an instance of VOAReportAck from a JSON string
voa_report_ack_instance = VOAReportAck.from_json(json)
# print the JSON string representation of the object
print(VOAReportAck.to_json())

# convert the object into a dict
voa_report_ack_dict = voa_report_ack_instance.to_dict()
# create an instance of VOAReportAck from a dict
voa_report_ack_from_dict = VOAReportAck.from_dict(voa_report_ack_dict)
```
