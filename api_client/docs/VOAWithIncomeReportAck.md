...
json = "{}"
# create an instance of VOAWithIncomeReportAck from a JSON string
voa_with_income_report_ack_instance = VOAWithIncomeReportAck.from_json(json)
# print the JSON string representation of the object
print(VOAWithIncomeReportAck.to_json())

# convert the object into a dict
voa_with_income_report_ack_dict = voa_with_income_report_ack_instance.to_dict()
# create an instance of VOAWithIncomeReportAck from a dict
voa_with_income_report_ack_from_dict = VOAWithIncomeReportAck.from_dict(voa_with_income_report_ack_dict)
```
