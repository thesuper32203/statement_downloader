...
json = "{}"
# create an instance of VOIReportAck from a JSON string
voi_report_ack_instance = VOIReportAck.from_json(json)
# print the JSON string representation of the object
print(VOIReportAck.to_json())

# convert the object into a dict
voi_report_ack_dict = voi_report_ack_instance.to_dict()
# create an instance of VOIReportAck from a dict
voi_report_ack_from_dict = VOIReportAck.from_dict(voi_report_ack_dict)
```
