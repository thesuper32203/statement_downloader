...
voe_transactions_report_ack_instance = VOETransactionsReportAck.from_json(json)
# print the JSON string representation of the object
print(VOETransactionsReportAck.to_json())

# convert the object into a dict
voe_transactions_report_ack_dict = voe_transactions_report_ack_instance.to_dict()
# create an instance of VOETransactionsReportAck from a dict
voe_transactions_report_ack_from_dict = VOETransactionsReportAck.from_dict(voe_transactions_report_ack_dict)
```
