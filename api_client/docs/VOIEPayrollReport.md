...
voie_payroll_report_instance = VOIEPayrollReport.from_json(json)
# print the JSON string representation of the object
print(VOIEPayrollReport.to_json())

# convert the object into a dict
voie_payroll_report_dict = voie_payroll_report_instance.to_dict()
# create an instance of VOIEPayrollReport from a dict
voie_payroll_report_from_dict = VOIEPayrollReport.from_dict(voie_payroll_report_dict)
```
