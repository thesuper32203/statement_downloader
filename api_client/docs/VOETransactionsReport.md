...
json = "{}"
# create an instance of VOETransactionsReport from a JSON string
voe_transactions_report_instance = VOETransactionsReport.from_json(json)
# print the JSON string representation of the object
print(VOETransactionsReport.to_json())

# convert the object into a dict
voe_transactions_report_dict = voe_transactions_report_instance.to_dict()
# create an instance of VOETransactionsReport from a dict
voe_transactions_report_from_dict = VOETransactionsReport.from_dict(voe_transactions_report_dict)
```
