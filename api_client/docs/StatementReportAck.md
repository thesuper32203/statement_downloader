...
json = "{}"
# create an instance of StatementReportAck from a JSON string
statement_report_ack_instance = StatementReportAck.from_json(json)
# print the JSON string representation of the object
print(StatementReportAck.to_json())

# convert the object into a dict
statement_report_ack_dict = statement_report_ack_instance.to_dict()
# create an instance of StatementReportAck from a dict
statement_report_ack_from_dict = StatementReportAck.from_dict(statement_report_ack_dict)
```
