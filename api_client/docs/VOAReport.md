...
json = "{}"
# create an instance of VOAReport from a JSON string
voa_report_instance = VOAReport.from_json(json)
# print the JSON string representation of the object
print(VOAReport.to_json())

# convert the object into a dict
voa_report_dict = voa_report_instance.to_dict()
# create an instance of VOAReport from a dict
voa_report_from_dict = VOAReport.from_dict(voa_report_dict)
```
