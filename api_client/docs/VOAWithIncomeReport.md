...
json = "{}"
# create an instance of VOAWithIncomeReport from a JSON string
voa_with_income_report_instance = VOAWithIncomeReport.from_json(json)
# print the JSON string representation of the object
print(VOAWithIncomeReport.to_json())

# convert the object into a dict
voa_with_income_report_dict = voa_with_income_report_instance.to_dict()
# create an instance of VOAWithIncomeReport from a dict
voa_with_income_report_from_dict = VOAWithIncomeReport.from_dict(voa_with_income_report_dict)
```
