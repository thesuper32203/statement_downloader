...
class TestAnalyticsReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnalyticsReportAck:
        """Test AnalyticsReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticsReportAck`
        """
        model = AnalyticsReportAck()
        if include_optional:
    ...
    def testAnalyticsReportAck(self):
        """Test AnalyticsReportAck"""
