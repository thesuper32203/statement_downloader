...
class TestBalanceAnalyticsReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BalanceAnalyticsReport:
        """Test BalanceAnalyticsReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceAnalyticsReport`
        """
        model = BalanceAnalyticsReport()
        if include_optional:
            return BalanceAnalyticsReport(
                account_results = [
                    openapi_client.models.balance_analytics_account_result.BalanceAnalyticsAccountResult(
                ...
                business_id = 4444,
                business_summary = openapi_client.models.balance_analytics_business_summary.BalanceAnalyticsBusinessSummary(
                    balance_analytics_metrics = openapi_client.models.balance_analytics_metrics.BalanceAnalyticsMetrics(
                        available_balance = 1000.01, 
                        available_balance_date = '2022-02-18T02:34:00-07:00', 
                        average_daily_balance_by_month_for_the_report_time_period = [
                ...
                report_header = openapi_client.models.obb_report_header.ObbReportHeader(
