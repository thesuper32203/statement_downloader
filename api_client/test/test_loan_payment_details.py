...
class TestLoanPaymentDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LoanPaymentDetails:
        """Test LoanPaymentDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoanPaymentDetails`
        """
        model = LoanPaymentDetails()
        if include_optional:
            return LoanPaymentDetails(
                ...
                account_detail = openapi_client.models.loan_payment_details_account.LoanPaymentDetailsAccount(
