...
class TestThirdPartyAccessReceiptData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ThirdPartyAccessReceiptData:
        """Test ThirdPartyAccessReceiptData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThirdPartyAccessReceiptData`
        """
        model = ThirdPartyAccessReceiptData()
        if include_optional:
