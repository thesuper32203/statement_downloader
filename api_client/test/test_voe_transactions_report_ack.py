...
class TestVOETransactionsReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOETransactionsReportAck:
        """Test VOETransactionsReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOETransactionsReportAck`
        """
        model = VOETransactionsReportAck()
        if include_optional:
            return VOETransactionsReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.voe_transactions_report_constraints_out.VOETransactionsReportConstraintsOut(
