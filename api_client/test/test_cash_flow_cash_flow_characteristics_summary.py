...
class TestCashFlowCashFlowCharacteristicsSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CashFlowCashFlowCharacteristicsSummary:
        """Test CashFlowCashFlowCharacteristicsSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashFlowCashFlowCharacteristicsSummary`
        """
        model = CashFlowCashFlowCharacteristicsSummary()
        if include_optional:
