...
class TestPayStatementReportConstraints(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PayStatementReportConstraints:
        """Test PayStatementReportConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayStatementReportConstraints`
        """
        model = PayStatementReportConstraints()
        if include_optional:
