...
class TestCashFlowAnalyticsBusinessSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CashFlowAnalyticsBusinessSummary:
        """Test CashFlowAnalyticsBusinessSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashFlowAnalyticsBusinessSummary`
        """
        model = CashFlowAnalyticsBusinessSummary()
        if include_optional:
