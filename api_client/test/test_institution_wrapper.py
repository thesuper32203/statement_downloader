...
class TestInstitutionWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InstitutionWrapper:
        """Test InstitutionWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstitutionWrapper`
        """
        model = InstitutionWrapper()
        if include_optional:
            return InstitutionWrapper(
                institution = openapi_client.models.institution.Institution(
                    id = 4222, 
                    name = 'FinBank', 
                    trans_agg = True, 
                    ach = True, 
