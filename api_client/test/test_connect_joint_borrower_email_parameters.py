...
class TestConnectJointBorrowerEmailParameters(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConnectJointBorrowerEmailParameters:
        """Test ConnectJointBorrowerEmailParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectJointBorrowerEmailParameters`
        """
        model = ConnectJointBorrowerEmailParameters()
        if include_optional:
