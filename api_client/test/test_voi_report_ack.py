...
class TestVOIReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIReportAck:
        """Test VOIReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIReportAck`
        """
        model = VOIReportAck()
        if include_optional:
            return VOIReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.voi_report_constraints_out.VOIReportConstraintsOut(
