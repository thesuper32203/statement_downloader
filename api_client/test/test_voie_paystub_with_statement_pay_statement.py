...
class TestVOIEPaystubWithStatementPayStatement(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIEPaystubWithStatementPayStatement:
        """Test VOIEPaystubWithStatementPayStatement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIEPaystubWithStatementPayStatement`
        """
        model = VOIEPaystubWithStatementPayStatement()
        if include_optional:
            return VOIEPaystubWithStatementPayStatement(
                ...
                monthly_income = openapi_client.models.paystub_tx_verify_monthly_income_record.PaystubTxVerifyMonthlyIncomeRecord(
