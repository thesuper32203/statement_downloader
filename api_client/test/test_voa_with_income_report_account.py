...
class TestVOAWithIncomeReportAccount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOAWithIncomeReportAccount:
        """Test VOAWithIncomeReportAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOAWithIncomeReportAccount`
        """
        model = VOAWithIncomeReportAccount()
        if include_optional:
            return VOAWithIncomeReportAccount(
                id = 1000023996,
                number = '1111',
                ...
                income_streams = [
                    openapi_client.models.voai_report_income_stream.VOAIReportIncomeStream(
