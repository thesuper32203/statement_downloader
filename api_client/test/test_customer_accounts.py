...
class TestCustomerAccounts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CustomerAccounts:
        """Test CustomerAccounts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerAccounts`
        """
        model = CustomerAccounts()
        if include_optional:
            return CustomerAccounts(
                accounts = [
                    openapi_client.models.customer_account.CustomerAccount(
                        id = '5011648377', 
                        number = '2000004444', 
