...
class TestPrequalificationReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PrequalificationReportAck:
        """Test PrequalificationReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrequalificationReportAck`
        """
        model = PrequalificationReportAck()
        if include_optional:
            return PrequalificationReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.prequalification_report_constraints_out.PrequalificationReportConstraintsOut(
