...
class TestVOETransactionsReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOETransactionsReport:
        """Test VOETransactionsReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOETransactionsReport`
        """
        model = VOETransactionsReport()
        if include_optional:
            return VOETransactionsReport(
                id = 'u4hstnnak45g',
