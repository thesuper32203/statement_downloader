...
class TestStateTimeInterval(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StateTimeInterval:
        """Test StateTimeInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateTimeInterval`
        """
        model = StateTimeInterval()
        if include_optional:
    ...
    def testStateTimeInterval(self):
        """Test StateTimeInterval"""
