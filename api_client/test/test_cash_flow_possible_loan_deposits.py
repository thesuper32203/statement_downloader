...
class TestCashFlowPossibleLoanDeposits(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CashFlowPossibleLoanDeposits:
        """Test CashFlowPossibleLoanDeposits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashFlowPossibleLoanDeposits`
        """
        model = CashFlowPossibleLoanDeposits()
        if include_optional:
