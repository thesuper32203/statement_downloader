...
class TestLoanPaymentDetailsGroup(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LoanPaymentDetailsGroup:
        """Test LoanPaymentDetailsGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoanPaymentDetailsGroup`
        """
        model = LoanPaymentDetailsGroup()
        if include_optional:
