...
class TestCashFlowReportAccount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CashFlowReportAccount:
        """Test CashFlowReportAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashFlowReportAccount`
        """
        model = CashFlowReportAccount()
        if include_optional:
            return CashFlowReportAccount(
                id = 6681984,
