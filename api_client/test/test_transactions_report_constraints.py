...
class TestTransactionsReportConstraints(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionsReportConstraints:
        """Test TransactionsReportConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionsReportConstraints`
        """
        model = TransactionsReportConstraints()
        if include_optional:
