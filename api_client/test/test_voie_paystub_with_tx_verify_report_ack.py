...
class TestVOIEPaystubWithTXVerifyReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIEPaystubWithTXVerifyReportAck:
        """Test VOIEPaystubWithTXVerifyReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIEPaystubWithTXVerifyReportAck`
        """
        model = VOIEPaystubWithTXVerifyReportAck()
        if include_optional:
            return VOIEPaystubWithTXVerifyReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.voie_with_tx_verify_report_constraints_out.VOIEWithTXVerifyReportConstraintsOut(
