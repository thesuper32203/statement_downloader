...
class TestVOAWithIncomeReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOAWithIncomeReportAck:
        """Test VOAWithIncomeReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOAWithIncomeReportAck`
        """
        model = VOAWithIncomeReportAck()
        if include_optional:
            return VOAWithIncomeReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.voa_with_income_report_constraints_out.VOAWithIncomeReportConstraintsOut(
