...
class TestVOIReportIncomeStream(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIReportIncomeStream:
        """Test VOIReportIncomeStream
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIReportIncomeStream`
        """
        model = VOIReportIncomeStream()
        if include_optional:
