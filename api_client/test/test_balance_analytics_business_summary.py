...
class TestBalanceAnalyticsBusinessSummary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BalanceAnalyticsBusinessSummary:
        """Test BalanceAnalyticsBusinessSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceAnalyticsBusinessSummary`
        """
        model = BalanceAnalyticsBusinessSummary()
        if include_optional:
