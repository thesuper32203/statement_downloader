...
class TestVOAWithIncomeReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOAWithIncomeReport:
        """Test VOAWithIncomeReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOAWithIncomeReport`
        """
        model = VOAWithIncomeReport()
        if include_optional:
            return VOAWithIncomeReport(
                id = 'u4hstnnak45g',
