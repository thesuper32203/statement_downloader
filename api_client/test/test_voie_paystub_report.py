...
class TestVOIEPaystubReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIEPaystubReport:
        """Test VOIEPaystubReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIEPaystubReport`
        """
        model = VOIEPaystubReport()
        if include_optional:
            return VOIEPaystubReport(
                id = 'u4hstnnak45g',
                ...
                pay_statements = [
                    openapi_client.models.voie_paystub_pay_statement.VOIEPaystubPayStatement()
                    ]
            )
        else:
            return VOIEPaystubReport(
