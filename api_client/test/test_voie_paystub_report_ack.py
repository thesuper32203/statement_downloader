...
class TestVOIEPaystubReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIEPaystubReportAck:
        """Test VOIEPaystubReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIEPaystubReportAck`
        """
        model = VOIEPaystubReportAck()
        if include_optional:
            return VOIEPaystubReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.voie_report_constraints.VOIEReportConstraints(
