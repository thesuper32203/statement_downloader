...
class TestGetInstitutionsByRoutingNumber200Response(unittest.TestCase):
    """GetInstitutionsByRoutingNumber200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetInstitutionsByRoutingNumber200Response:
        """Test GetInstitutionsByRoutingNumber200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetInstitutionsByRoutingNumber200Response`
        """
        model = GetInstitutionsByRoutingNumber200Response()
        if include_optional:
            return GetInstitutionsByRoutingNumber200Response(
                found = 200,
                displaying = 1,
                more_available = True,
                created_date = 1607450357,
                institutions = [
                    openapi_client.models.institutions_with_routing_number.InstitutionsWithRoutingNumber(
                        id = 4222, 
                        name = 'FinBank', 
                        trans_agg = True, 
                        ach = True, 
    ...
    def testGetInstitutionsByRoutingNumber200Response(self):
        """Test GetInstitutionsByRoutingNumber200Response"""
