...
class TestAccountOwnerVerificationMatchResults(unittest.TestCase):
    """AccountOwnerVerificationMatchResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountOwnerVerificationMatchResults:
        """Test AccountOwnerVerificationMatchResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountOwnerVerificationMatchResults`
        """
        model = AccountOwnerVerificationMatchResults()
        if include_optional:
            return AccountOwnerVerificationMatchResults(
                holders = [
                    openapi_client.models.account_owner_verification_matching_details.AccountOwnerVerificationMatchingDetails(
                ...
                encrypted_value = 'eyJraWQiOiI3NjFiMDAzYzFlYWRlM(...)==.Y+oPYKZEMTKyYcSIVEgtQw=='
            )
        else:
            return AccountOwnerVerificationMatchResults(
        )
    ...
    def testAccountOwnerVerificationMatchResults(self):
        """Test AccountOwnerVerificationMatchResults"""
