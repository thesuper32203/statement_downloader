...
class TestAnalyticsReportConstraints(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnalyticsReportConstraints:
        """Test AnalyticsReportConstraints
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyticsReportConstraints`
        """
        model = AnalyticsReportConstraints()
        if include_optional:
    ...
    def testAnalyticsReportConstraints(self):
        """Test AnalyticsReportConstraints"""
