...
class TestCashFlowReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CashFlowReportAck:
        """Test CashFlowReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CashFlowReportAck`
        """
        model = CashFlowReportAck()
        if include_optional:
            return CashFlowReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.cash_flow_report_constraints_out.CashFlowReportConstraintsOut(
