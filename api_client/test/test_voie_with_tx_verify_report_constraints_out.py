...
class TestVOIEWithTXVerifyReportConstraintsOut(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOIEWithTXVerifyReportConstraintsOut:
        """Test VOIEWithTXVerifyReportConstraintsOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOIEWithTXVerifyReportConstraintsOut`
        """
        model = VOIEWithTXVerifyReportConstraintsOut()
        if include_optional:
