...
class TestBaseReportAckWithPortfolioId(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BaseReportAckWithPortfolioId:
        """Test BaseReportAckWithPortfolioId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseReportAckWithPortfolioId`
        """
        model = BaseReportAckWithPortfolioId()
        if include_optional:
            return BaseReportAckWithPortfolioId(
                id = 'u4hstnnak45g',
