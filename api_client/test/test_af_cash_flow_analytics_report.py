...
class TestAFCashFlowAnalyticsReport(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AFCashFlowAnalyticsReport:
        """Test AFCashFlowAnalyticsReport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFCashFlowAnalyticsReport`
        """
        model = AFCashFlowAnalyticsReport()
        if include_optional:
            return AFCashFlowAnalyticsReport(
                id = 'u4hstnnak45g',
    ...
    def testAFCashFlowAnalyticsReport(self):
        """Test AFCashFlowAnalyticsReport"""
