...
class TestPayrollReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PayrollReportAck:
        """Test PayrollReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayrollReportAck`
        """
        model = PayrollReportAck()
        if include_optional:
            return PayrollReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.payroll_report_constraints_out.PayrollReportConstraintsOut(
