...
class TestFcraNsfReturnRisk(unittest.TestCase):
    """FcraNsfReturnRisk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FcraNsfReturnRisk:
        """Test FcraNsfReturnRisk
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FcraNsfReturnRisk`
        """
        model = FcraNsfReturnRisk()
        if include_optional:
            return FcraNsfReturnRisk(
    ...
    def testFcraNsfReturnRisk(self):
        """Test FcraNsfReturnRisk"""
