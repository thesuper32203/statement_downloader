...
class TestVOAReportAck(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VOAReportAck:
        """Test VOAReportAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VOAReportAck`
        """
        model = VOAReportAck()
        if include_optional:
            return VOAReportAck(
                ...
                type = 'voi',
                status = 'inProgress',
                constraints = openapi_client.models.voa_report_constraints_out.VOAReportConstraintsOut(
