...
class CustomerAccountsSimple(BaseModel):
    ...
    """ # noqa: E501
    accounts: List[CustomerAccountSimple] = Field(description="A list of accounts with basic information of a customer")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [CustomerAccountSimple.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
