...
class EnrichedTransactions(BaseModel):
    """
    Request body that contains transactions to be enriched.
    """ # noqa: E501
    transactions: Optional[List[EnrichedTransaction]] = Field(default=None, description="List of input transactions to be enriched.")
