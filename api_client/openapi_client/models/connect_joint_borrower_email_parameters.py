...
class ConnectJointBorrowerEmailParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["language", "partnerId", "borrowers", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "institutionSettings", "email", "experience", "fromDate", "reportCustomFields", "singleUseUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": EmailOptions.from_dict(obj["email"]) if obj.get("email") is not None else None,
