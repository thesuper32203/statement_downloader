...
class ConnectEmailParameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["language", "partnerId", "customerId", "consumerId", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "institutionSettings", "email", "experience", "singleUseUrl", "fromDate", "reportCustomFields", "optionalConsumerInfo"]
