...
class GoldStandardErrorMessage(BaseModel):
    """
    GoldStandardErrorMessage
    """ # noqa: E501
    errors: GoldStandardErrorMessageErrors = Field(alias="Errors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Errors": GoldStandardErrorMessageErrors.from_dict(obj["Errors"]) if obj.get("Errors") is not None else None
        })
        return _obj
