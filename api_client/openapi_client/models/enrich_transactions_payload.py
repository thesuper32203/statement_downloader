...
class EnrichTransactionsPayload(BaseModel):
    """
    Request body that contains transactions to be enriched.
    """ # noqa: E501
    transactions: Annotated[List[TransactionPayload], Field(min_length=1, max_length=1000)] = Field(description="A list of transactions requested to be enriched.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [TransactionPayload.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
