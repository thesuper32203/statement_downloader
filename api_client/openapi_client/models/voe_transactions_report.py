...
class VOETransactionsReport(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "startDate", "endDate", "days", "seasoned", "institutions"]
