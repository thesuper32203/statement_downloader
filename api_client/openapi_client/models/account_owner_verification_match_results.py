...
class AccountOwnerVerificationMatchResults(BaseModel):
    """
    AccountOwnerVerificationMatchResults
    """ # noqa: E501
    holders: Optional[List[AccountOwnerVerificationMatchingDetails]] = None
    encrypted_value: Optional[StrictStr] = Field(default=None, description="Encrypted response.", alias="encryptedValue")
    __properties: ClassVar[List[str]] = ["holders", "encryptedValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "holders": [AccountOwnerVerificationMatchingDetails.from_dict(_item) for _item in obj["holders"]] if obj.get("holders") is not None else None,
