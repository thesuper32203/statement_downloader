...
class CertifiedInstitutions(BaseModel):
    ...
    requested_date: StrictInt = Field(description="A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).", alias="requestedDate")
    institutions: Annotated[List[CertifiedInstitution], Field(min_length=0, max_length=1000)] = Field(description="A list of institutions")
    __properties: ClassVar[List[str]] = ["found", "displaying", "moreAvailable", "requestedDate", "institutions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "institutions": [CertifiedInstitution.from_dict(_item) for _item in obj["institutions"]] if obj.get("institutions") is not None else None
        })
        return _obj
