...
class ListAvailableWebhookSubscriptionEvents200Response(BaseModel):
    """
    ListAvailableWebhookSubscriptionEvents200Response
    """ # noqa: E501
    events: List[AvailableEvent] = Field(description="List of available events.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [AvailableEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj
