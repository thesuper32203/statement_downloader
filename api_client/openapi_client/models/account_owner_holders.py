...
class AccountOwnerHolders(BaseModel):
    ...
    AccountOwnerHolders
    """ # noqa: E501
    holders: List[AccountOwnerDetails] = Field(description="List of account owners")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "holders": [AccountOwnerDetails.from_dict(_item) for _item in obj["holders"]] if obj.get("holders") is not None else None
        })
        return _obj
