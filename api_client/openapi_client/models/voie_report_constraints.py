...
class VOIEReportConstraints(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["voieWithStatementData", "reportCustomFields"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of voie_with_statement_data
        if self.voie_with_statement_data:
            _dict['voieWithStatementData'] = self.voie_with_statement_data.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "voieWithStatementData": VOIEWithStatementData.from_dict(obj["voieWithStatementData"]) if obj.get("voieWithStatementData") is not None else None,
