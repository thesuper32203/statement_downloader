...
class PayStatementForVoie(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payPeriod", "billable", "assetId", "payDate", "startDate", "endDate", "netPayCurrent", "netPayYTD", "grossPayCurrent", "grossPayYTD", "payrollProvider", "employer", "employee", "payStat", "directDeposits", "institutions", "errorCode", "errorMessage"]
