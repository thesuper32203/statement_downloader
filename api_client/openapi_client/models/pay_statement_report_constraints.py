...
class PayStatementReportConstraints(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paystatementReport", "reportCustomFields"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of paystatement_report
        if self.paystatement_report:
            _dict['paystatementReport'] = self.paystatement_report.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "paystatementReport": PayStatementData.from_dict(obj["paystatementReport"]) if obj.get("paystatementReport") is not None else None,
