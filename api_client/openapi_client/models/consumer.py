...
class Consumer(BaseModel):
    ...
    ssn: StrictStr = Field(description="Last 4 digits of a SSN")
    birthday: Birthday
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "customerId", "address", "city", "state", "zip", "phone", "ssn", "birthday", "email", "createdDate", "suffix", "endUser"]
