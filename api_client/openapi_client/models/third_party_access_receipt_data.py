...
class ThirdPartyAccessReceiptData(BaseModel):
    ...
    """ # noqa: E501
    receipt: Optional[ThirdPartyAccessReceipt] = None
    proof: Optional[ThirdPartyAccessProof] = None
    __properties: ClassVar[List[str]] = ["receipt", "proof"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "receipt": ThirdPartyAccessReceipt.from_dict(obj["receipt"]) if obj.get("receipt") is not None else None,
            "proof": ThirdPartyAccessProof.from_dict(obj["proof"]) if obj.get("proof") is not None else None
        })
        return _obj
