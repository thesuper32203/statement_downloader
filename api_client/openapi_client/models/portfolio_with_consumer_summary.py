...
class PortfolioWithConsumerSummary(BaseModel):
    """
    ...
    reports: List[PortfolioReport] = Field(description="A list of reports in the portfolio")
    consumer: PortfolioConsumer
    __properties: ClassVar[List[str]] = ["portfolioId", "reports", "consumer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reports": [PortfolioReport.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None,
            "consumer": PortfolioConsumer.from_dict(obj["consumer"]) if obj.get("consumer") is not None else None
        })
        return _obj
