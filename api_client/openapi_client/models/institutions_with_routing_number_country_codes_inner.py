...
class InstitutionsWithRoutingNumberCountryCodesInner(BaseModel):
    """
    Countries for which this connection is valid
    """ # noqa: E501
    country_code: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=2)]] = Field(default=None, description="Two character country code", alias="countryCode")
