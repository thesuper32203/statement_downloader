...
class ReportTransaction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "amount", "postedDate", "description", "memo", "normalizedPayee", "institutionTransactionId", "category", "type", "securityType", "symbol", "commission"]
