...
class DeviceInsights(BaseModel):
    ...
    """ # noqa: E501
    scores: Optional[DeviceScores] = None
    details: Optional[DeviceDetails] = None
    __properties: ClassVar[List[str]] = ["scores", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scores": DeviceScores.from_dict(obj["scores"]) if obj.get("scores") is not None else None,
