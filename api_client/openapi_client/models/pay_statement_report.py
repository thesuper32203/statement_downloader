...
class PayStatementReport(BaseModel):
    """
    ...
    number_of_billable_assets: Optional[StrictInt] = Field(default=None, description="Total number of billable pay statements included in the report", alias="numberOfBillableAssets")
    asset_ids: Optional[List[StrictStr]] = Field(default=None, alias="assetIds")
    pay_statements: Optional[List[VOIEPayStatement]] = Field(default=None, description="Extracted pay statement details", alias="payStatements")
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "startDate", "endDate", "reportStyle", "numberOfBillableAssets", "assetIds", "payStatements"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.errors:
            ...
            _dict['errors'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in pay_statements (list)
        _items = []
        if self.pay_statements:
            for _item_pay_statements in self.pay_statements:
                if _item_pay_statements:
                    _items.append(_item_pay_statements.to_dict())
            _dict['payStatements'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numberOfBillableAssets": obj.get("numberOfBillableAssets"),
            "assetIds": obj.get("assetIds"),
            "payStatements": [VOIEPayStatement.from_dict(_item) for _item in obj["payStatements"]] if obj.get("payStatements") is not None else None
        })
        return _obj
