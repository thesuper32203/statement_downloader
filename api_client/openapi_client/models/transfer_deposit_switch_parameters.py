...
class TransferDepositSwitchParameters(BaseModel):
    """
    TransferDepositSwitchParameters
    """ # noqa: E501
    service_agreement: Optional[ServiceAgreement] = Field(default=None, alias="serviceAgreement")
    accounts: List[DepositSwitchAccount] = Field(description="List of customer accounts (one or more) for Deposit Switch.")
    ...
    __properties: ClassVar[List[str]] = ["serviceAgreement", "accounts", "partnerId", "customerId", "language", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "redirectUri", "experience"]
