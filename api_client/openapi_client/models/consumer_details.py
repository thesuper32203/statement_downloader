...
class ConsumerDetails(BaseModel):
    """
    ...
    ssn: Optional[StrictStr] = Field(default=None, description="Last 4 digits of a SSN")
    email: Optional[StrictStr] = Field(default=None, description="An email address")
    __properties: ClassVar[List[str]] = ["id", "firstName", "middleName", "lastName", "address", "city", "state", "zip", "phone", "ssn", "email"]
