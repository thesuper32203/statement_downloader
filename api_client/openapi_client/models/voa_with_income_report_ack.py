...
class VOAWithIncomeReportAck(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "constraints": VOAWithIncomeReportConstraintsOut.from_dict(obj["constraints"]) if obj.get("constraints") is not None else None,
