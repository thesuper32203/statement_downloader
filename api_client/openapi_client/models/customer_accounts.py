...
class CustomerAccounts(BaseModel):
    ...
    """ # noqa: E501
    accounts: List[CustomerAccount] = Field(description="List of customer accounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [CustomerAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
