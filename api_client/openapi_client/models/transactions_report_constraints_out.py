...
class TransactionsReportConstraintsOut(BaseModel):
    ...
    include_pending: Optional[StrictBool] = Field(default=False, description="If pending transactions must be included", alias="includePending")
    ...
    __properties: ClassVar[List[str]] = ["accountIds", "fromDate", "toDate", "includePending", "reportCustomFields", "findTransaction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includePending": obj.get("includePending") if obj.get("includePending") is not None else False,
