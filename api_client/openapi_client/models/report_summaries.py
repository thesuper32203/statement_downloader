...
class ReportSummaries(BaseModel):
    ...
    ReportSummaries
    """ # noqa: E501
    reports: List[ReportSummary] = Field(description="Data pertaining to each report")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reports": [ReportSummary.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
