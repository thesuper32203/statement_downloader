...
class ThirdPartyAccessKeyData(BaseModel):
    ...
    third_party_partner_id: StrictStr = Field(description="Your Partner ID displayed in the [Developer Dashboard](https://developer.mastercard.com/account/log-in)", alias="thirdPartyPartnerId")
    provenance: Optional[ThirdPartyAccessProvenance] = None
    products: List[ThirdPartyAccessProduct]
    __properties: ClassVar[List[str]] = ["customerId", "partnerId", "thirdPartyPartnerId", "provenance", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thirdPartyPartnerId": obj.get("thirdPartyPartnerId"),
