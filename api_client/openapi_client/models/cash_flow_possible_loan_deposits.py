...
class CashFlowPossibleLoanDeposits(BaseModel):
    ...
    """ # noqa: E501
    institutions: List[CashFlowPossibleLoanDepositsInstitutions] = Field(description="A list of loan deposit institutions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "institutions": [CashFlowPossibleLoanDepositsInstitutions.from_dict(_item) for _item in obj["institutions"]] if obj.get("institutions") is not None else None
        })
        return _obj
