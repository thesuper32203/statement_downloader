...
class AccountOwnerDetails(BaseModel):
    ...
    addresses: Optional[List[AccountOwnerAddress]] = Field(default=None, description="List of addresses")
    emails: Optional[List[AccountOwnerEmail]] = Field(default=None, description="List of emails")
    phones: Optional[List[AccountOwnerPhone]] = Field(default=None, description="List of phones")
    ...
    __properties: ClassVar[List[str]] = ["relationship", "ownerName", "firstName", "middleName", "lastName", "suffix", "nameClassification", "nameClassificationconfidencescore", "addresses", "emails", "phones", "documentations", "identityInsights"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addresses": [AccountOwnerAddress.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None,
            "emails": [AccountOwnerEmail.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "phones": [AccountOwnerPhone.from_dict(_item) for _item in obj["phones"]] if obj.get("phones") is not None else None,
