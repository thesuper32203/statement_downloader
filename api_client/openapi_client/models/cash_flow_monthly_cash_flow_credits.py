...
class CashFlowMonthlyCashFlowCredits(BaseModel):
    ...
    number_of_credits: StrictStr = Field(description="Number of credits by month", alias="numberOfCredits")
    total_credits_amount: Union[StrictFloat, StrictInt] = Field(description="Total amount of credits by month", alias="totalCreditsAmount")
    largest_credit: Union[StrictFloat, StrictInt] = Field(description="Largest credit by month", alias="largestCredit")
    number_of_credits_less_transfers: StrictStr = Field(description="Number of credits by month (less transfers)", alias="numberOfCreditsLessTransfers")
    total_credits_amount_less_transfers: Union[StrictFloat, StrictInt] = Field(description="Total amount of credits by month (less transfers)", alias="totalCreditsAmountLessTransfers")
    average_credit_amount: Union[StrictFloat, StrictInt] = Field(description="The average credit amount", alias="averageCreditAmount")
    estimated_number_of_loan_deposits: StrictStr = Field(description="The estimated number of loan deposits", alias="estimatedNumberOfLoanDeposits")
    estimated_loan_deposit_amount: Union[StrictFloat, StrictInt] = Field(description="The estimated loan deposit amount", alias="estimatedLoanDepositAmount")
