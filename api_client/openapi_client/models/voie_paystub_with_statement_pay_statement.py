...
class VOIEPaystubWithStatementPayStatement(BaseModel):
    """
    ...
    monthly_income: PaystubTxVerifyMonthlyIncomeRecord = Field(alias="monthlyIncome")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthlyIncome": PaystubTxVerifyMonthlyIncomeRecord.from_dict(obj["monthlyIncome"]) if obj.get("monthlyIncome") is not None else None
        })
        return _obj
