...
class VOIEPaystubReport(BaseModel):
    """
    ...
    pay_statements: Optional[List[VOIEPaystubPayStatement]] = Field(default=None, description="Extracted pay statement details, and the transaction matching summary", alias="payStatements")
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "assetIds", "numberOfBillableAssets", "payStatements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payStatements": [VOIEPaystubPayStatement.from_dict(_item) for _item in obj["payStatements"]] if obj.get("payStatements") is not None else None
        })
        return _obj
