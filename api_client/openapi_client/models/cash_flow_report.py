...
class CashFlowReport(BaseModel):
    ...
    start_date: Optional[StrictInt] = Field(default=None, description="The `postedDate` of the earliest transaction analyzed for the report. A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).", alias="startDate")
    end_date: Optional[StrictInt] = Field(default=None, description="The `postedDate` of the latest transaction analyzed for the report. A date in Unix epoch time (in seconds). See: [Handling Epoch Dates and Times](https://developer.mastercard.com/open-banking-us/documentation/codes-and-formats/).", alias="endDate")
    days: Optional[StrictInt] = Field(default=None, description="Number of days covered by the report")
    seasoned: Optional[StrictBool] = Field(default=None, description="\"true\" if the report covers more than 365 days")
    institutions: Optional[List[ReportInstitution]] = Field(default=None, description="A list of institution records, including information about the individual accounts used in this report")
    cash_flow_balance_summary: Optional[CashFlowCashFlowBalanceSummary] = Field(default=None, alias="cashFlowBalanceSummary")
    cash_flow_credit_summary: Optional[CashFlowCashFlowCreditSummary] = Field(default=None, alias="cashFlowCreditSummary")
    cash_flow_debit_summary: Optional[CashFlowCashFlowDebitSummary] = Field(default=None, alias="cashFlowDebitSummary")
    cash_flow_characteristics_summary: Optional[CashFlowCashFlowCharacteristicsSummary] = Field(default=None, alias="cashFlowCharacteristicsSummary")
    possible_loan_deposits: Optional[List[CashFlowPossibleLoanDeposits]] = Field(default=None, description="A possible loan deposits record", alias="possibleLoanDeposits")
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "startDate", "endDate", "days", "seasoned", "institutions", "cashFlowBalanceSummary", "cashFlowCreditSummary", "cashFlowDebitSummary", "cashFlowCharacteristicsSummary", "possibleLoanDeposits"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of cash_flow_balance_summary
        if self.cash_flow_balance_summary:
            _dict['cashFlowBalanceSummary'] = self.cash_flow_balance_summary.to_dict()
        # override the default output from pydantic by calling `to_dict()` of cash_flow_credit_summary
        if self.cash_flow_credit_summary:
            _dict['cashFlowCreditSummary'] = self.cash_flow_credit_summary.to_dict()
        # override the default output from pydantic by calling `to_dict()` of cash_flow_debit_summary
        if self.cash_flow_debit_summary:
            _dict['cashFlowDebitSummary'] = self.cash_flow_debit_summary.to_dict()
        # override the default output from pydantic by calling `to_dict()` of cash_flow_characteristics_summary
        if self.cash_flow_characteristics_summary:
            _dict['cashFlowCharacteristicsSummary'] = self.cash_flow_characteristics_summary.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in possible_loan_deposits (list)
        _items = []
        if self.possible_loan_deposits:
            for _item_possible_loan_deposits in self.possible_loan_deposits:
                if _item_possible_loan_deposits:
                    _items.append(_item_possible_loan_deposits.to_dict())
            _dict['possibleLoanDeposits'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "days": obj.get("days"),
            "seasoned": obj.get("seasoned"),
            "institutions": [ReportInstitution.from_dict(_item) for _item in obj["institutions"]] if obj.get("institutions") is not None else None,
            "cashFlowBalanceSummary": CashFlowCashFlowBalanceSummary.from_dict(obj["cashFlowBalanceSummary"]) if obj.get("cashFlowBalanceSummary") is not None else None,
            "cashFlowCreditSummary": CashFlowCashFlowCreditSummary.from_dict(obj["cashFlowCreditSummary"]) if obj.get("cashFlowCreditSummary") is not None else None,
            "cashFlowDebitSummary": CashFlowCashFlowDebitSummary.from_dict(obj["cashFlowDebitSummary"]) if obj.get("cashFlowDebitSummary") is not None else None,
            "cashFlowCharacteristicsSummary": CashFlowCashFlowCharacteristicsSummary.from_dict(obj["cashFlowCharacteristicsSummary"]) if obj.get("cashFlowCharacteristicsSummary") is not None else None,
            "possibleLoanDeposits": [CashFlowPossibleLoanDeposits.from_dict(_item) for _item in obj["possibleLoanDeposits"]] if obj.get("possibleLoanDeposits") is not None else None
        })
        return _obj
