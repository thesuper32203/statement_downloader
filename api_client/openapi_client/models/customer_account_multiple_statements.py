...
class CustomerAccountMultipleStatements(BaseModel):
    ...
    """ # noqa: E501
    statements: List[CustomerAccountMultipleStatement] = Field(description="List of customer account statements")
    __properties: ClassVar[List[str]] = ["statements"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statements": [CustomerAccountMultipleStatement.from_dict(_item) for _item in obj["statements"]] if obj.get("statements") is not None else None
        })
        return _obj
