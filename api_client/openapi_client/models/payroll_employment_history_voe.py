...
class PayrollEmploymentHistoryVOE(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["asOfDate", "employerName", "payrollSource", "payrollProvider", "employee", "employment", "income"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "income": PayrollVOEIncomeRecord.from_dict(obj["income"]) if obj.get("income") is not None else None
        })
        return _obj
