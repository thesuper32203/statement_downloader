...
class VOAWithIncomeReport(BaseModel):
    """
    ...
    seasoned: Optional[StrictBool] = Field(default=None, description="\"true\" if the report covers more than 180 days")
    consolidated_available_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The sum of available balance for all of the accounts included in the report", alias="consolidatedAvailableBalance")
    institutions: Optional[List[ReportInstitution]] = Field(default=None, description="A list of institution records")
    assets: Optional[PrequalificationReportAssetSummary] = None
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "startDate", "endDate", "days", "seasoned", "consolidatedAvailableBalance", "institutions", "assets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "consolidatedAvailableBalance": obj.get("consolidatedAvailableBalance"),
            ...
            "assets": PrequalificationReportAssetSummary.from_dict(obj["assets"]) if obj.get("assets") is not None else None
        })
        return _obj
