...
class AvailableBalancePEB(BaseModel):
    """
    AvailableBalancePEB
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="An account ID represented as a number")
    ...
    available_balance: Union[Annotated[float, Field(le=10000000000000000, strict=True, ge=0)], Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(description="The available balance of the account", alias="availableBalance")
    available_balance_date: datetime = Field(description="A date-time with time zone", alias="availableBalanceDate")
    cleared_balance: Union[Annotated[float, Field(le=9999999999999, strict=True, ge=0)], Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(description="The cleared balance of the account. Also referred as posted balance, current balance, ledger balance", alias="clearedBalance")
    cleared_balance_date: datetime = Field(description="A date-time with time zone", alias="clearedBalanceDate")
