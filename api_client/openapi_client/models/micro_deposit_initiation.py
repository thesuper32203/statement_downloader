...
class MicroDepositInitiation(BaseModel):
    ...
    """ # noqa: E501
    institution_login_id: Optional[StrictStr] = Field(default=None, description="An institution login ID (from the account record)", alias="institutionLoginId")
    receiver: Receiver
    callback_url: Optional[StrictStr] = Field(default=None, description="A callback URL where to receive micro deposit notifications", alias="callbackUrl")
    __properties: ClassVar[List[str]] = ["institutionLoginId", "receiver", "callbackUrl"]
