...
class VOEPayrollReport(BaseModel):
    """
    ...
    employment_history: Optional[List[PayrollEmploymentHistoryVOE]] = Field(default=None, description="An array of employment histories, one for each of the consumer's verified employers", alias="employmentHistory")
    ...
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "employmentHistory", "gseEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employmentHistory": [PayrollEmploymentHistoryVOE.from_dict(_item) for _item in obj["employmentHistory"]] if obj.get("employmentHistory") is not None else None,
