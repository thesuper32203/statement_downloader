...
class VOIEPaystubWithTXVerifyReport(BaseModel):
    """
    ...
    asset_ids: Optional[List[StrictStr]] = Field(default=None, description="The pay statements included in the report", alias="assetIds")
    ...
    pay_statements: Optional[List[VOIEPaystubWithStatementPayStatement]] = Field(default=None, description="Extracted pay statement details, and the transaction matching summary", alias="payStatements")
    institutions: Optional[List[ReportInstitution]] = Field(default=None, description="The details of the financial institution accounts included in the report.")
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "assetIds", "numberOfBillableAssets", "payStatements", "institutions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payStatements": [VOIEPaystubWithStatementPayStatement.from_dict(_item) for _item in obj["payStatements"]] if obj.get("payStatements") is not None else None,
