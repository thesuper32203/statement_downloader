...
class FixConnectParameters(BaseModel):
    ...
    institution_login_id: StrictStr = Field(description="An institution login ID (from the account record)", alias="institutionLoginId")
    ...
    __properties: ClassVar[List[str]] = ["language", "partnerId", "customerId", "institutionLoginId", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "experience", "singleUseUrl", "isHostedInMobileApp", "isWebView"]
