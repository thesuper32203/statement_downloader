...
class ObbAccountOwner(BaseModel):
    ...
    """ # noqa: E501
    address: Annotated[str, Field(min_length=0, strict=True, max_length=255)] = Field(description="Address of the owner on record for the account")
    name: Annotated[str, Field(min_length=0, strict=True, max_length=255)] = Field(description="Name of the owner on record for the account")
