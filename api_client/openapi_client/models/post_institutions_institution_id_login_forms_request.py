...
class PostInstitutionsInstitutionIdLoginFormsRequest(BaseModel):
    """
    Object used to generate a new session'ed login form.
    """ # noqa: E501
    language: StrictStr = Field(description="The preferred language translation of the requested login form. Supported languages are English:'en', English-United States:'en-us', Spanish:'es', Spanish-United States:'es-us', French:'fr', French-Canada:'fr-ca'")
    ...
    __properties: ClassVar[List[str]] = ["language", "customerId", "configurationId", "serviceAgreement"]
