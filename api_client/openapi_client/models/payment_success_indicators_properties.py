...
class PaymentSuccessIndicatorsProperties(BaseModel):
    """
    Properties to request a Payment Success Indicator score
    """ # noqa: E501
    transaction: PaymentSuccessIndicatorsTransaction
    user: Optional[PaymentSuccessIndicatorsUser] = None
    __properties: ClassVar[List[str]] = ["transaction", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": PaymentSuccessIndicatorsUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
