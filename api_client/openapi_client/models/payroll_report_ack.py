...
class PayrollReportAck(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "reportStyle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "constraints": PayrollReportConstraintsOut.from_dict(obj["constraints"]) if obj.get("constraints") is not None else None,
