...
class BillingResellerReport(BaseModel):
    """
    ...
    content: Optional[List[BillingReport]] = None
    empty: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["totalPages", "totalElements", "numberOfElements", "pageable", "sort", "number", "first", "last", "size", "content", "empty"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last": obj.get("last"),
            "size": obj.get("size"),
            "content": [BillingReport.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "empty": obj.get("empty")
        })
        return _obj
