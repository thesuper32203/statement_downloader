...
class VOIETXVerifyReportIncomeStream(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Finicity's income stream ID")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "status", "confidence", "cadence", "netMonthly", "netAnnual", "projectedNetAnnual", "estimatedGrossAnnual", "projectedGrossAnnual", "averageMonthlyIncomeNet", "incomeStreamMonths", "transactions"]
