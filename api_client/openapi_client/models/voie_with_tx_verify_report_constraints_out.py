...
class VOIEWithTXVerifyReportConstraintsOut(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountIds", "voieWithInterviewData", "reportCustomFields", "fromDate", "incomeStreamConfidenceMinimum"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of voie_with_interview_data
        if self.voie_with_interview_data:
            _dict['voieWithInterviewData'] = self.voie_with_interview_data.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "voieWithInterviewData": VOIEWithInterviewData.from_dict(obj["voieWithInterviewData"]) if obj.get("voieWithInterviewData") is not None else None,
