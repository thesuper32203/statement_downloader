...
class ForesightAnalyticsReportConstraints(BaseModel):
    """
    ForesightAnalyticsReportConstraints
    """ # noqa: E501
    analytics_report_data: Optional[ForesightAnalyticsReportData] = Field(default=None, alias="analyticsReportData")
    ...
    __properties: ClassVar[List[str]] = ["analyticsReportData", "accountIds", "fromDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "analyticsReportData": ForesightAnalyticsReportData.from_dict(obj["analyticsReportData"]) if obj.get("analyticsReportData") is not None else None,
