...
class PrequalificationReport(BaseModel):
    """
    ...
    days: Optional[StrictInt] = Field(default=None, description="The number of days covered by the report")
    ...
    institutions: Optional[List[ReportInstitution]] = Field(default=None, description="A list of institution records, including information about the individual accounts in this report")
