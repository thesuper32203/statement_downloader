...
class FcraPaymentSuccessIndicators(BaseModel):
    """
    ...
    nsf_return_risk: Optional[FcraNsfReturnRisk] = Field(default=None, alias="nsfReturnRisk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nsfReturnRisk": FcraNsfReturnRisk.from_dict(obj["nsfReturnRisk"]) if obj.get("nsfReturnRisk") is not None else None,
