...
class RegisteredApplication(BaseModel):
    ...
    """ # noqa: E501
    pre_app_id: StrictInt = Field(description="Identifier to track the application registration from the App Registration and Get App Registration Status APIs, represented as a number", alias="preAppId")
    ...
    __properties: ClassVar[List[str]] = ["preAppId", "status"]
