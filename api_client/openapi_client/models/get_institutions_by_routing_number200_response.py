...
class GetInstitutionsByRoutingNumber200Response(BaseModel):
    """
    GetInstitutionsByRoutingNumber200Response
    """ # noqa: E501
    found: Optional[StrictInt] = Field(default=None, description="The total number of results matching search criteria")
    displaying: Optional[StrictInt] = Field(default=None, description="The number of results returned")
    more_available: Optional[StrictBool] = Field(default=None, description="If the value of `moreAvailable` is \"true\", you can retrieve the next page of results by increasing the value of the start parameter in your next request:\"...&start=6&limit=5\"", alias="moreAvailable")
    ...
    institutions: Optional[List[InstitutionsWithRoutingNumber]] = Field(default=None, description="List of institutions with matching routing numbers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "institutions": [InstitutionsWithRoutingNumber.from_dict(_item) for _item in obj["institutions"]] if obj.get("institutions") is not None else None
        })
        return _obj
