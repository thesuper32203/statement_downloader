...
class GoldStandardErrorMessageErrors(BaseModel):
    """
    GoldStandardErrorMessageErrors
    """ # noqa: E501
    error: List[GoldStandardErrorMessageErrorsErrorInner] = Field(description="Mastercard standard error message.", alias="Error")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Error": [GoldStandardErrorMessageErrorsErrorInner.from_dict(_item) for _item in obj["Error"]] if obj.get("Error") is not None else None
        })
        return _obj
