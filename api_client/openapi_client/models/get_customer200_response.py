...
class GetCustomer200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "username", "firstName", "lastName", "phone", "email", "type", "createdDate", "lastModifiedDate", "applicationId"]
