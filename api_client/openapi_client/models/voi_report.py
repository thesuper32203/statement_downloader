...
class VOIReport(BaseModel):
    ...
    income: Optional[List[ReportIncomeStreamSummary]] = Field(default=None, description="Income details")
    __properties: ClassVar[List[str]] = ["id", "customerType", "customerId", "requestId", "requesterName", "endUser", "createdDate", "title", "consumerId", "consumerSsn", "consumerDetails", "disputeStatement", "type", "status", "constraints", "errors", "portfolioId", "startDate", "endDate", "days", "seasoned", "institutions", "income"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "income": [ReportIncomeStreamSummary.from_dict(_item) for _item in obj["income"]] if obj.get("income") is not None else None
        })
        return _obj
