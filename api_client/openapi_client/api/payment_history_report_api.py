...
class PaymentHistoryReportApi:
    ...
    @validate_call
    def generate_payment_history_report(
        self,
        ...
        _param = self._generate_payment_history_report_serialize(
    ...
    @validate_call
    def generate_payment_history_report_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        user_type: Annotated[StrictStr, Field(description="UserType indicates if the request is for a business or personal use case, Allowed values: business/personal.")],
        analytics_report_constraints: AnalyticsReportConstraints,
    ...
    @validate_call
    def generate_payment_history_report_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        user_type: Annotated[StrictStr, Field(description="UserType indicates if the request is for a business or personal use case, Allowed values: business/personal.")],
        analytics_report_constraints: AnalyticsReportConstraints,
    ...
    def _generate_payment_history_report_serialize(
        self,
        customer_id,
        user_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/decisioning/customers/{customerId}/reports/payment-history/userTypes/{userType}',
