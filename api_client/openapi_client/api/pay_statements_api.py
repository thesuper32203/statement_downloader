...
class PayStatementsApi:
    ...
    def store_customer_pay_statement(
        ...
        :param pay_statement: (required)
        :type pay_statement: PayStatement
        ...
        _param = self._store_customer_pay_statement_serialize(
    ...
    @validate_call
    def store_customer_pay_statement_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        pay_statement: PayStatement,
        _request_timeout: Union[
    ...
    @validate_call
    def store_customer_pay_statement_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        pay_statement: PayStatement,
        _request_timeout: Union[
    ...
    def _store_customer_pay_statement_serialize(
        self,
        customer_id,
        pay_statement,
        _request_auth,
        ...
        if pay_statement is not None:
            _body_params = pay_statement
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/aggregation/v1/customers/{customerId}/payStatements',
