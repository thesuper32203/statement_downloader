...
class AccountValidationAssistanceApi:
    ...
    def get_micro_deposits_details(
        ...
        _param = self._get_micro_deposits_details_serialize(
    ...
    @validate_call
    def get_micro_deposits_details_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        account_id: Annotated[StrictStr, Field(description="The account ID")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MicroDepositDetails]:
        """Get Micro Entries Details
    ...
    @validate_call
    def get_micro_deposits_details_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        account_id: Annotated[StrictStr, Field(description="The account ID")],
        _request_timeout: Union[
    ...
    def _get_micro_deposits_details_serialize(
        self,
        customer_id,
        account_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/microentry/v1/customers/{customerId}/accounts/{accountId}',
    ...
    def initiate_micro_amount_deposits(
        ...
        :param customer_id: A customer ID (required)
        :type customer_id: str
        :param micro_deposit_initiation: (required)
        :type micro_deposit_initiation: MicroDepositInitiation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._initiate_micro_amount_deposits_serialize(
            customer_id=customer_id,
            micro_deposit_initiation=micro_deposit_initiation,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def initiate_micro_amount_deposits_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        micro_deposit_initiation: MicroDepositInitiation,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[InitiatedMicroDeposit]:
        """Initiate Micro Entries
    ...
    @validate_call
    def initiate_micro_amount_deposits_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        micro_deposit_initiation: MicroDepositInitiation,
        _request_timeout: Union[
    ...
    def _initiate_micro_amount_deposits_serialize(
        self,
        customer_id,
        ...
        # process the form parameters
        # process the body parameter
        if micro_deposit_initiation is not None:
            _body_params = micro_deposit_initiation
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/microentry/v1/customers/{customerId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def verify_micro_amount_deposits(
        ...
        :param account_id: The account ID (required)
        :type account_id: str
        :param micro_deposit_verification: (required)
        :type micro_deposit_verification: MicroDepositVerification
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._verify_micro_amount_deposits_serialize(
            customer_id=customer_id,
            account_id=account_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VerifiedMicroDeposit",
            '400': "MicroDepositVerificationError",
            '401': "ErrorMessage",
            '404': "ErrorMessage",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def verify_micro_amount_deposits_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        account_id: Annotated[StrictStr, Field(description="The account ID")],
        micro_deposit_verification: MicroDepositVerification,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VerifiedMicroDeposit]:
        """Verify Micro Entries
    ...
    @validate_call
    def verify_micro_amount_deposits_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        account_id: Annotated[StrictStr, Field(description="The account ID")],
        micro_deposit_verification: MicroDepositVerification,
    ...
    def _verify_micro_amount_deposits_serialize(
        self,
        customer_id,
        account_id,
        ...
        # process the form parameters
        # process the body parameter
        if micro_deposit_verification is not None:
            _body_params = micro_deposit_verification
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/microentry/v1/customers/{customerId}/accounts/{accountId}/amounts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
