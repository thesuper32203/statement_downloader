...
class AnalyticsApi:
    ...
    @validate_call
    def generate_foresight_analytics_non_cra_report(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        user_type: Annotated[StrictStr, Field(description="UserType indicates if the request is for a personal use case, Allowed values: personal.")],
        foresight_analytics_report_constraints: ForesightAnalyticsReportConstraints,
        ...
        :param user_type: UserType indicates if the request is for a personal use case, Allowed values: personal. (required)
        :type user_type: str
        :param foresight_analytics_report_constraints: (required)
        :type foresight_analytics_report_constraints: ForesightAnalyticsReportConstraints
        ...
        _param = self._generate_foresight_analytics_non_cra_report_serialize(
            customer_id=customer_id,
            user_type=user_type,
            foresight_analytics_report_constraints=foresight_analytics_report_constraints,
    ...
    @validate_call
    def generate_foresight_analytics_non_cra_report_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        user_type: Annotated[StrictStr, Field(description="UserType indicates if the request is for a personal use case, Allowed values: personal.")],
        foresight_analytics_report_constraints: ForesightAnalyticsReportConstraints,
    ...
    @validate_call
    def generate_foresight_analytics_non_cra_report_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="A customer ID")],
        user_type: Annotated[StrictStr, Field(description="UserType indicates if the request is for a personal use case, Allowed values: personal.")],
        foresight_analytics_report_constraints: ForesightAnalyticsReportConstraints,
    ...
    def _generate_foresight_analytics_non_cra_report_serialize(
        self,
        customer_id,
        user_type,
        foresight_analytics_report_constraints,
        callback_url,
        _request_auth,
        _content_type,
        _headers,
        ...
        if foresight_analytics_report_constraints is not None:
            _body_params = foresight_analytics_report_constraints
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/decisioning/customers/{customerId}/reports/foresight-analytics/userTypes/{userType}',
